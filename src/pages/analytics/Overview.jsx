  ...
  return (
    <>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={2}><StatCard title="Total Claims" value={claims.length} /></Grid><Grid item xs={12} md={2}><StatCard title="Claims Settled" value={settled.length} /></Grid><Grid item xs={12} md={2}><StatCard title="Total Settlement" value={formatCurrency(sumBy(claims, 'netPayable'))} /></Grid><Grid item xs={12} md={2}><StatCard title="Avg Settlement" value={formatCurrency(Math.round(sumBy(claims, 'netPayable') / claims.length))} /></Grid><Grid item xs={12} md={2}><StatCard title="Avg TAT" value="8 days" /></Grid><Grid item xs={12} md={2}><StatCard title="Rejection Rate" value={`${Math.round((rejected.length / claims.length) * 100)}%`} /></Grid>
